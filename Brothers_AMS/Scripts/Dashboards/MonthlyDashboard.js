$(function () {
    ...
    $("#Generatetblsss").on("click", Getchosen);
...
function Getchosen() {
    ...
    if ($("#Bigchosen").val() != "") {
        ...
        swal("Please choose Dashboard Type");
    }
...
function GraphAttendanceRate_Monthly(datahere) {
    var finalticks = [];
    var Present = [];
    var Absent = [];
    var PresentInactive = [];
    ...
    chartOptions = {
        ...
        colors: colored,//['#4f81bd', '#77933c', '#FF2020'],
        legend: {
...
function GraphStartAbsentRate_Monthly(datahere) {
    var finalticks = [];
    var TotalDayAbsent = [];
...
function GraphStartLeaveBreakdown_Monthly(datahere) {
    var finalticks = [];
    //var LeaveType = [];
    var HeadCount = [];
    var Iterator = 1;
...
function GraphStartGET_AWOLandResignrate_Monthly(datahere) {
    var finalticks = [];
    var Status = [];
    var HeadCount = [];
...
function GraphStartOTrate_Monthly(datahere) {
    var finalticks = [];
    var HeadCount = [];
    var OTHours = [];
    var Iterator = 1;
