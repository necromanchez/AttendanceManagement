...
function AttendanceRate_Yearly() {
    ...
    //AttendanceRate
    $.ajax({
        url: '/Home/GetYearly_AttendanceRate',
        type: 'POST',
        data: {
            Agency: MAgency,
            Line: MLine,
        ...
        success: function (returnData) {
            ...
            graphstartYearly_AttendanceRate(obj);
    ...
    $.ajax({
        ...
        success: function (returnData) {
            var obj = JSON.parse(returnData.data);
            graphstartYearly_AbsentRate(obj);
        }
    });
    ...
    //AwolResignRate
    $.ajax({
        url: '/Home/GetYearly_AwolResignRate',
        type: 'POST',
        data: {
            Agency: MAgency,
            Line: MLine,
        ...
        success: function (returnData) {
            ...
            var obj = JSON.parse(returnData.data);
            graphstartYearly_AwolResignRate(obj);
        }
    });
    ...
    //AbsentBreakdown
    $.ajax({
        url: '/Home/GetYearly_LeaveBreakdown',
        type: 'POST',
        data: {
            Agency: MAgency,
            Line: MLine,
        ...
        success: function (returnData) {
            ...
            var obj = JSON.parse(returnData.data);
            graphstartYearly_LeaveBreakdown(obj);
        }
    });
...
function graphstartYearly_AttendanceRate(datahere) {
    ...
    for (var x = 0; x < datahere.length; x++) {
        var Tickshere = [x, datahere[x].Year];
        var Per = [x, datahere[x].TotalMP];
        var Pre = [x, datahere[x].Present];
        var abs = [x, datahere[x].Absent];
...
function graphstartYearly_AbsentRate(datahere) {
...
function graphstartYearly_AwolResignRate(datahere) {
...
function graphstartYearly_LeaveBreakdown(datahere) {

    var groupedMonth = _.mapValues(_.groupBy(datahere, 'Year'),
                       clist => clist.map(Section => _.omit(Section, 'Year')));
    ...
    data = [VLSet, SLSet, MLSet, ELSet,UNKSet];
    var tickis = ticksMonth;
...
function graphstartYearly_OT(datahere) {
